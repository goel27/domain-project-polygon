...
const tld = ".anime";
const CONTRACT_ADDRESS = "0x4c6445d9E3bAA56566A628Fb05a20D7C5E2682C6";
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      ...
      <img
        src="https://media.giphy.com/media/nJltjZMYwoQMdm56R8/giphy.gif"
        width="480"
        height="320"
        frameBorder="0"
        ...
        alt="Anime gif"
      ></img>
      <p>A new journey in a fantasy world</p>
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="whats ur character power"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🌀 Anime Name Service</p>
              <p className="subtitle">
                Your favourite anime on the blockchain!
              </p>
            </div>
